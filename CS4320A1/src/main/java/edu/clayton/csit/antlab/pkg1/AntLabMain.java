 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Christopher");
		  toPrint += p1.toString("900693507");
		  //Person2 replace P2 with your name
		  //and csuLaker with your laker id
		  Person2 p2 = new Person2("Allen Nguyen");
		  toPrint += p2.toString("900643430");
		  //Person3 replace P3 with your name
		  //and csuLaker3 with your laker id
		  Person3 p3 = new Person3("Alena Welch");
		  toPrint += p3.toString("900733439");
